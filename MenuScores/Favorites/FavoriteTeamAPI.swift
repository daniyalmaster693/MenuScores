...
enum FavoriteTeams {
    ...
    static let mappings: [String: LeagueInfo] = [
        ...
        "NCAAM": LeagueInfo(sport: "basketball", league: "mens-college-basketball", displayName: "NCAA M"),
        "NCAAF": LeagueInfo(sport: "basketball", league: "womens-college-basketball", displayName: "NCAA F"),
        ...
        "AFL": LeagueInfo(sport: "australian-football", league: "afl", displayName: "AFL"),
        ...
        "BRA1": LeagueInfo(sport: "soccer", league: "bra.1", displayName: "Brazilian Serie A"),
        "BRA2": LeagueInfo(sport: "soccer", league: "bra.2", displayName: "Brazilian Serie B"),
        "KSA": LeagueInfo(sport: "soccer", league: "ksa.1", displayName: "Saudi Pro League"),
    ...
    static var supportedLeagueKeys: [String] {
        ...
        return mappings.keys.filter { league in
            ...
            case "AFL": return defaults.bool(forKey: "enableAFL")
            ...
            case "BRA1": return defaults.bool(forKey: "enableBRA1")
            case "BRA2": return defaults.bool(forKey: "enableBRA2")
            case "KSA": return defaults.bool(forKey: "enableKSA")
