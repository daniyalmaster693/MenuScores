                                        ...
                                        Button {
                                            ...
                                            Task {
                                                ...
                                                let newNotch = DynamicNotch(
                                                    ...
                                                    CompactLeading(notchViewModel: notchViewModel, sport: "Basketball", league: "\(league)")
                                                } compactTrailing: {
                                                    CompactTrailing(notchViewModel: notchViewModel, sport: "Basketball", league: "\(league)")
                                                }
