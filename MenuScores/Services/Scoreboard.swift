...
enum Scoreboard {
    enum Urls {
        static let nhl: () -> URL = {
            URL(
                string: "https://site.api.espn.com/apis/site/v2/sports/hockey/nhl/scoreboard"
            )!
        }
        ...
        static let f1: () -> URL = {
            URL(
                string:
                "https://site.web.api.espn.com/apis/personalized/v2/scoreboard/header?sport=racing&league=f1&dates=\(getCurrentYearMonth())"
            )!
        }
